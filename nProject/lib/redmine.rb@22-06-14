...
Redmine::AccessControl.map do |map|
  ...
  map.project_module :issue_tracking do |map|
    # Issue categories
    map.permission :manage_categories, {:projects => :settings, :issue_categories => [:index, :show, :tasks, :new, :create, :edit, :update, :destroy]}, :require => :member
    # Issues
...
Redmine::MenuManager.map :project_menu do |menu|
  ...
  #menu.push :task, { :controller => 'issues', :action => 'tasks' }, :param => :project_id, :caption => "All Tasks", :after => :overview
  menu.push :activity, { :controller => 'activities', :action => 'index' }
  menu.push :roadmap, { :controller => 'versions', :action => 'index' }, :param => :project_id,
              :if => Proc.new { |p| p.shared_versions.any? }
  menu.push :issues, { :controller => 'issues', :action => 'index' }, :param => :project_id, :caption => "Issues"
  menu.push :tasklist, { :controller => 'issues', :action => 'tasks' }, :param => :project_id, :caption => :tasklist, :after => :issues
  #menu.push :new_issue, { :controller => 'issues', :action => 'new' }, :param => :project_id, :caption => "New Issue",
